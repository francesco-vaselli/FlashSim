# the loop for generating new UPSAMPLED events files starting from gen-level information in the files
...
if __name__ == "__main__":
    ...
    jet_flow, _, _, _, trh, tsh = mynflow.load_model(
        "../nflows/saves", "model_jets_final_@epoch_420.pt"
    )
    muon_flow, _, _, _, trh, tsh = mynflow.load_model(
        "../nflows/saves", "model_muons_final_@epoch_580.pt"
    )
