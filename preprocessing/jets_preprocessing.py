...
if __name__ == "__main__":
    ...
    # apply saturations to distributions tails
    ...
    # apply saturations to tagging distributions negative values
    ...
    # apply dequantization (gaussian smearing) to Ids distributions
